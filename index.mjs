// Central Bank of Belize exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbbz';
...
/** Latest rate for one pair, e.g. getRate('USD', 'BZD', { apiKey }). */
